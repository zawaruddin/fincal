	     	...
	     	<div class="row">
	      		<div class="span12">
	      			<div class="info-box">
               			<div class="row-fluid">
                  			<div class="span12">
								<h1 class="text-center mt20"><small><?php echo anchor("income/$y_prev/$m_prev", "&laquo; Prev")?></small>&nbsp;&nbsp;&nbsp;<?php echo $mon.' '.$year?>&nbsp;&nbsp;&nbsp;<small><?php echo anchor("income/$y_next/$m_next", "Next &raquo;")?></small></h1>
								<hr>
